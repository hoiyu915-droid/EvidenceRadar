...
from tools.apply_master_runtime_config import effective_configs  # noqa: E402


class ApplyMasterRuntimeConfigTests(unittest.TestCase):
    def test_effective_configs_project_master_limits(self) -> None:
        output, deployment, summary = effective_configs(ROOT, "current_plus_general")
    ...
    def test_profile_override_changes_runtime_projection_only_for_that_profile(self) -> None:
        with tempfile.TemporaryDirectory() as directory:
            ...
            output, deployment, _summary = effective_configs(root, "llm_reader")
